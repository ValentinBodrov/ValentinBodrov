...
import hw3.ex2.components.LeftSideMenu;
import hw3.ex2.components.RightSideComponent;
...
public class DifferentElementsPage extends AbstractBasePage {
    ...
    public int getNumberOfLogsInLogRow() {
        return leftSideMenu.getServiceLeftSideItems().size();
    }
